...
## 8.2 AI思考整形（Summarization + Reconstruction）
...
- **フロント:** React Native
- **文字起こし:** Whisper / Whisper.cpp（ローカル推奨）
- **要約・整形AI:** 未選定（OpenAI / Gemini / Claude等を想定）
- **データ保存:** SQLite / Realm
- **Markdown生成:** 独自テンプレートエンジン
